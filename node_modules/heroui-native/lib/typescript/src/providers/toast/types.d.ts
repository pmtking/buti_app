 ...
 */
export interface ToastGlobalConfig extends Pick<ToastRootProps, 'variant' | 'placement' | 'isSwipeable' | 'animation'> {
}
/**
 ...
 */
export interface ToastShowConfig extends Pick<ToastRootProps, 'variant' | 'placement' | 'isSwipeable' | 'animation'> {
    /**
 ...
 */
export type ToastShowOptions = ToastShowOptionsWithComponent | (ToastShowConfig & {
    component?: never;
});
/**
