 ...
 */
export type ControlFieldRenderProps = Pick<ControlFieldProps, 'isSelected' | 'isDisabled' | 'isInvalid'>;
/**
 ...
 */
export interface ControlFieldContextValue extends Pick<ControlFieldProps, 'isSelected' | 'onSelectedChange' | 'isDisabled' | 'isInvalid'> {
    isPressed: SharedValue<boolean>;
}
//# sourceMappingURL=control-field.types.d.ts.map