...
import type { AnimatedProps, WithSpringConfig, WithTimingConfig } from 'react-native-reanimated';
 ...
 */
type TabsIndicatorPropertyAnimationValue = TabsIndicatorSpringAnimationValue | TabsIndicatorTimingAnimationValue;
/**
