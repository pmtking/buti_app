...
import type { Animation, AnimationRootDisableAll, AnimationValue, BaseBottomSheetContentProps, ElementSlots, PopupDialogContentAnimation, PopupOverlayAnimation, PopupPopoverContentAnimation } from '../../helpers/internal/types';
 ...
 */
export type SelectRootProps<M extends SelectPrimitivesTypes.SelectionMode = 'single'> = SelectPrimitivesTypes.RootProps<M> & {
    /**
 ...
 */
export interface SelectTriggerIndicatorProps extends AnimatedProps<SelectPrimitivesTypes.TriggerIndicatorProps> {
    /**
 ...
 */
export interface SelectContentBottomSheetProps extends Partial<BottomSheetProps>, BaseBottomSheetContentProps {
    /**
     * Presentation mode for the select
     */
 ...
 */
export type SelectContentProps = SelectContentPopoverProps | SelectContentBottomSheetProps | SelectContentDialogProps;
/**
