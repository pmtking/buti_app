...
import type { AnimationRootDisableAll, BaseBottomSheetContentProps, PopupOverlayAnimation, PopupPopoverContentAnimation } from '../../helpers/internal/types';
 ...
 */
export interface PopoverContentBottomSheetProps extends Partial<BottomSheetProps>, BaseBottomSheetContentProps {
    /**
