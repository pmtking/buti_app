...
import type { AnimationRootDisableAll, BaseBottomSheetContentProps, PopupOverlayAnimation } from '../../helpers/internal/types';
 ...
 */
export interface BottomSheetContentProps extends Partial<BottomSheetProps>, BaseBottomSheetContentProps {
}
/**
...
//# sourceMappingURL=bottom-sheet.types.d.ts.map