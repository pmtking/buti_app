...
import type { AnimatedProps, EntryOrExitLayoutType } from 'react-native-reanimated';
import type { AnimationRoot, AnimationValue, ElementSlots } from '../../helpers/internal/types';
 ...
 */
export interface FieldErrorRootProps extends Omit<AnimatedProps<ViewProps>, 'entering' | 'exiting'> {
    /**
...
//# sourceMappingURL=field-error.types.d.ts.map