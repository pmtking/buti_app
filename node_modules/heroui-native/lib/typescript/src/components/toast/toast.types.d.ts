...
import type { AnimationRoot, AnimationValue, ViewRef } from '../../helpers/internal/types';
 ...
 */
export type UseToastRootAnimationOptions = Pick<ToastRootProps, 'animation' | 'index' | 'total' | 'heights' | 'placement' | 'hide' | 'isSwipeable' | 'maxVisibleToasts'> & Pick<ToastComponentProps, 'id'>;
/**
