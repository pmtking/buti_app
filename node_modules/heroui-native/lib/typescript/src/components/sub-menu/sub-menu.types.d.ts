 ...
 */
export interface SubMenuContentProps extends Omit<SubMenuPrimitivesTypes.ContentProps, 'forceMount'> {
...
export type { ISubMenuContext, ContentRef as SubMenuContentRef, RootRef as SubMenuRootRef, TriggerRef as SubMenuTriggerRef, } from '../../primitives/sub-menu/sub-menu.types';
//# sourceMappingURL=sub-menu.types.d.ts.map