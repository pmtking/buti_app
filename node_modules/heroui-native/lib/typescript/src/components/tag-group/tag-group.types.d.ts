 ...
 */
export interface TagGroupItemProps extends Omit<TagGroupPrimitivesTypes.ItemProps, 'asChild' | 'children'> {
 ...
 */
export interface TagGroupItemRemoveButtonProps extends Omit<TagGroupPrimitivesTypes.RemoveButtonProps, 'asChild'> {
