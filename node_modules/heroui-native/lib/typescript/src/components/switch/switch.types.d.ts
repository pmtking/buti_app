import type { AnimatedProps, SharedValue, WithSpringConfig, WithTimingConfig } from 'react-native-reanimated';
 ...
 */
export interface SwitchThumbProps extends Omit<AnimatedProps<SwitchPrimitivesTypes.ThumbProps>, 'children'> {
