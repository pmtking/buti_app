...
import type { FallbackProps as PrimitiveFallbackProps, FallbackRef as PrimitiveFallbackRef, ImageProps as PrimitiveImageProps, ImageRef as PrimitiveImageRef, RootProps as PrimitiveRootProps, RootRef as PrimitiveRootRef } from '../../primitives/avatar';
 ...
 */
export type AvatarImageProps = (AnimatedProps<ImageProps> & {
    /**
     * Additional CSS classes
     *
 ...
 */
export interface AvatarFallbackProps extends Omit<AnimatedProps<PrimitiveFallbackProps>, 'entering'> {
    /**
