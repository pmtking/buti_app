...
import type { Animation, AnimationRootDisableAll, AnimationValue, BaseBottomSheetContentProps, PopupOverlayAnimation, PopupPopoverContentAnimation } from '../../helpers/internal/types';
 ...
 */
export interface MenuContentBottomSheetProps extends Partial<BottomSheetProps>, BaseBottomSheetContentProps {
    /**
...
export type { GroupSelectionMode as MenuGroupSelectionMode, ItemVariant as MenuItemVariant, MenuKey, } from '../../primitives/menu/menu.types';
