 ...
 */
export declare function useThemeColor(themeColor: ThemeColor): ThemeColorValue;
export declare function useThemeColor<T extends readonly [ThemeColor, ...ThemeColor[]]>(themeColor: T): CreateStringTuple<T['length']>;
export declare function useThemeColor(themeColor: ThemeColor[]): string[];
export {};
