import type { BaseAnimationBuilder, EntryOrExitLayoutType, LayoutAnimationFunction, WithSpringConfig, WithTimingConfig } from 'react-native-reanimated';
/**
 ...
 */
export type Animation<TConfig extends Record<string, any> = Record<string, any>> = boolean | 'disabled' | (TConfig & {
 ...
 */
export type AnimationRoot<TConfig extends Record<string, any> = Record<string, any>> = boolean | 'disabled' | 'disable-all' | (TConfig & {
 ...
 */
export type AnimationValue<TConfig extends Record<string, any> = Record<string, any>> = TConfig;
export type LayoutTransition = BaseAnimationBuilder | LayoutAnimationFunction | typeof BaseAnimationBuilder | undefined;
/**
