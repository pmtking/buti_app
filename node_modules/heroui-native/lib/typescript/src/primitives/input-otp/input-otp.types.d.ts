import type { BlurEvent, FocusEvent, PressableProps, TextInput, TextInputProps } from 'react-native';
...
export type RootProps = {
    ...
    textInputProps?: Omit<TextInputProps, 'value' | 'onChangeText' | 'maxLength' | 'placeholder' | 'placeholderTextColor' | 'placeholderTextClassName' | 'style' | 'className' | 'inputMode' | 'onFocus' | 'onBlur'>;
...
//# sourceMappingURL=input-otp.types.d.ts.map