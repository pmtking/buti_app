 ...
 */
type GroupContextValue = Required<Pick<GroupProps, 'selectionMode' | 'isDisabled'>> & {
...
export type { CloseProps, CloseRef, ContentProps, ContentRef, ContentSizing, GroupContextValue, GroupProps, GroupRef, GroupSelectionMode, IItemContext, IRootContext, ItemDescriptionProps, ItemDescriptionRef, ItemIndicatorProps, ItemIndicatorRef, ItemProps, ItemRef, ItemTitleProps, ItemTitleRef, ItemVariant, LabelProps, LabelRef, MenuKey, OverlayProps, OverlayRef, PortalProps, RootProps, RootRef, TriggerProps, TriggerRef, };
