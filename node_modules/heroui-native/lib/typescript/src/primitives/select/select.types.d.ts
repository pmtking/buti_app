...
import type { ForceMountable, PositionedContentProps, PressableRef, SlottablePressableProps, SlottableTextProps, SlottableViewProps, TextRef, ViewRef } from '../../helpers/internal/types';
/**
 ...
 */
type SelectValueType<M extends SelectionMode> = M extends 'single' ? SelectOption : SelectOption[];
/**
...
export type { CloseProps, CloseRef, ContentRef, ContentSizing, DialogContentProps, GroupLabelProps, GroupLabelRef, GroupProps, GroupRef, IRootContext, ItemIndicatorProps, ItemIndicatorRef, ItemLabelProps, ItemLabelRef, ItemProps, ItemRef, OverlayProps, OverlayRef, PopoverContentProps, PortalProps, RootProps, RootRef, SelectionMode, SelectOption, SelectState, SelectValue, SelectValueType, TriggerIndicatorProps, TriggerIndicatorRef, TriggerProps, TriggerRef, ValueProps, ValueRef, };
