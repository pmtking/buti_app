...
import type { PressableRef, SlottablePressableProps, SlottableTextProps, TextRef } from '../../helpers/internal/types';
/**
 ...
 */
type RootProps = Omit<SlottablePressableProps, 'children' | 'hitSlop' | 'disabled' | 'style'> & {
