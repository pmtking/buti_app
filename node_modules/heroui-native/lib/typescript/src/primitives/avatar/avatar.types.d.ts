...
import type { ComponentPropsWithAsChild, SlottableViewProps, ViewRef } from '../../helpers/internal/types';
/**
 ...
 */
type ImageProps = Omit<ComponentPropsWithAsChild<typeof Image>, 'alt' | 'source'> & {
...
export type { AvatarStatus, FallbackProps, FallbackRef, ImageProps, ImageRef, RootProps, RootRef, };
