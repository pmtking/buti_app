 ...
 */
type RootContextValue = Required<Pick<RootProps, 'selectionMode' | 'isDisabled' | 'isInvalid' | 'isRequired'>> & Pick<RootProps, 'onRemove'> & {
...
export type { ItemLabelProps, ItemLabelRef, ItemProps, ItemRef, ListProps, ListRef, RemoveButtonProps, RemoveButtonRef, RootContextValue, RootProps, RootRef, SelectionMode, TagKey, };
//# sourceMappingURL=tag-group.types.d.ts.map