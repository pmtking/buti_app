...
import type { PortalProps, RootContext } from './dialog.types';
...
declare const Overlay: import("react").ForwardRefExoticComponent<import("../../helpers/internal/types").ForceMountable & Omit<import("react-native").PressableProps & import("react").RefAttributes<View>, "ref"> & {
    asChild?: boolean;
} & {
