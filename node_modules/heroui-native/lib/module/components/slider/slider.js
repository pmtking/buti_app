...
import * as SliderPrimitives from "../../primitives/slider/index.js";
import { useSlider } from "../../primitives/slider/index.js";
import { clamp } from "../../primitives/slider/slider.utils.js";
import { useSliderRootAnimation, useSliderThumbAnimation } from "./slider.animation.js";
import { DISPLAY_NAME } from "./slider.constants.js";
import sliderClassNames, { styleSheet } from "./slider.styles.js";
import { jsx as _jsx } from "react/jsx-runtime";
const AnimatedKnob = Animated.createAnimatedComponent(View);

// --------------------------------------------------

const SliderRoot = /*#__PURE__*/forwardRef((props, ref) => {
  const {
    children,
  ...
  return /*#__PURE__*/_jsx(AnimationSettingsProvider, {
    ...
    children: /*#__PURE__*/_jsx(SliderPrimitives.Root, {
      ref: ref,
...
const SliderOutput = /*#__PURE__*/forwardRef((props, ref) => {
  const {
    children,
    className,
    classNames,
  ...
  return /*#__PURE__*/_jsx(SliderPrimitives.Output, {
    ref: ref,
    className: containerClassName,
    style: style,
    ...restProps,
    children: resolvedChildren ?? /*#__PURE__*/_jsx(HeroText, {
...
const SliderTrack = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const tapGesture = useMemo(() => {
    ...
    return Gesture.Tap().runOnJS(true).enabled(!isDisabled).onEnd(event => {
      if (effectiveTrackSize <= 0) return;
      const pos = orientation === 'horizontal' ? event.x : event.y;
      const adjustedPos = orientation === 'horizontal' ? pos - thumbSize / 2 : trackSize - pos - thumbSize / 2;
  ...
  return /*#__PURE__*/_jsx(GestureDetector, {
    gesture: tapGesture,
    children: /*#__PURE__*/_jsx(SliderPrimitives.Track, {
      ref: ref,
...
const SliderFill = /*#__PURE__*/forwardRef((props, ref) => {
  const {
    className,
    style,
    ...restProps
  ...
  const fillClassName = sliderClassNames.fill({
    orientation,
    className
  });
  ...
  return /*#__PURE__*/_jsx(SliderPrimitives.Fill, {
    ref: ref,
...
const SliderThumb = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  const panGesture = useMemo(() => {
    const effectiveTrackSize = trackSize - thumbSize;
    const gesture = Gesture.Pan().runOnJS(true).enabled(!disabled).onBegin(() => {
      ...
      const valueDelta = effectiveTrackSize > 0 ? delta / effectiveTrackSize * (maxValue - minValue) : 0;
  ...
  return /*#__PURE__*/_jsx(GestureDetector, {
    gesture: panGesture,
    children: /*#__PURE__*/_jsx(SliderPrimitives.Thumb, {
      ref: ref,
      index: index,
      ...
      hitSlop: hitSlop,
      ...restProps,
      children: children ?? /*#__PURE__*/_jsx(AnimatedKnob, {
