...
import { DISPLAY_NAME } from "./text.constants.js";
import { styleSheet, textClassNames } from "./text.styles.js";
import { jsx as _jsx } from "react/jsx-runtime";
// --------------------------------------------------

const TextRoot = /*#__PURE__*/forwardRef((props, ref) => {
  const {
    children,
    type = 'body',
    align = 'start',
...
const TextHeading = /*#__PURE__*/forwardRef((props, ref) => {
  const {
    type = 'h1',
    accessibilityRole = 'header',
    ...restProps
  } = props;
  return /*#__PURE__*/_jsx(TextRoot, {
    ref: ref,
    type: type,
...
const TextParagraph = /*#__PURE__*/forwardRef((props, ref) => {
  const {
    type = 'body',
    ...restProps
  } = props;
...
const TextCode = /*#__PURE__*/forwardRef((props, ref) => {
  return /*#__PURE__*/_jsx(TextRoot, {
    ref: ref,
    type: "code",
    ...props
