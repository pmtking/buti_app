...
import { useSubMenuContext as useSubMenu } from "../../primitives/sub-menu/index.js";
import { DEFAULT_ROOT_CONTENT_MARGIN, DEFAULT_ROOT_CONTENT_PADDING_HORIZONTAL, DEFAULT_ROOT_CONTENT_PADDING_TOP, INDICATOR_SPRING_CONFIG, ROOT_CONTENT_SPRING_CONFIG } from "./sub-menu.constants.js";
const [SubMenuAnimationProvider, useSubMenuAnimation] = createContext({
...
export function useRootContentContainerAnimation(options) {
  ...
  const rInnerContentStyle = useAnimatedStyle(() => {
    ...
    const targetHeight = isOpen ? triggerHeight.get() + contentHeight.get() + paddingTopValue : triggerHeight.get();
...
export { SubMenuAnimationProvider, useSubMenuAnimation };
//# sourceMappingURL=sub-menu.animation.js.map