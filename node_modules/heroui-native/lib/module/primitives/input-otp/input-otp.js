...
import * as SlotPrimitive from "../slot/index.js";
import { defaultPasteTransformer } from "./input-otp.utils.js";
import { jsx as _jsx, jsxs as _jsxs } from "react/jsx-runtime";
const InputOTPContext = /*#__PURE__*/createContext(null);
...
const Root = /*#__PURE__*/forwardRef(({
  ...
  const slots = useMemo(() => {
    return Array.from({
      ...
      const placeholderChar = isActive ? null : value[slotIdx] !== undefined ? null : placeholder?.[slotIdx] ?? null;
      return {
        index: slotIdx,
        char,
        placeholderChar,
  ...
  const contextValue = useMemo(() => ({
    ...
    inputRef
  }), [value, maxLength, isFocused, isDisabled, isInvalid, variant, slots, placeholderTextColor, placeholderTextClassName, onChangeText, onFocus, onBlur, focus, clear]);
  ...
  const accessibilityValue = useMemo(() => ({
    text: value.length > 0 ? `${value.length} of ${maxLength} digits entered` : `0 of ${maxLength} digits entered`
  }), [value, maxLength]);
...
const Slot = /*#__PURE__*/forwardRef(({
  asChild,
  index,
  accessible = false,
  accessibilityRole = 'none',
  ...
  const computedAccessibilityLabel = accessibilityLabel ?? (accessible && slot ? `Digit ${index + 1} of ${maxLength}${slot.char ? `, value ${slot.char}` : ', empty'}` : undefined);
  const Component = asChild ? SlotPrimitive.View : View;
  return /*#__PURE__*/_jsx(Component, {
    ref: ref,
    accessible: accessible,
