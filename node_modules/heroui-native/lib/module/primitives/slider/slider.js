...
import { clamp, denormalizeValue, formatValue, normalizeValue, snapToStep, valueToPercent } from "./slider.utils.js";
...
const Root = /*#__PURE__*/forwardRef(({
  ...
  const getThumbMaxValue = useCallback(index => {
    return index === values.length - 1 ? maxValue : values[index + 1] ?? maxValue;
  }, [values, maxValue]);
  ...
  const updateValue = useCallback((index, newValue) => {
    ...
    if (newValues.length > 1) {
      ...
      if (index < newValues.length - 1 && newValue > (newValues[index + 1] ?? maxValue)) {
  ...
  }, [isDisabled, values, minValue, maxValue, step, setInternalValue, onChangeEnd]);
  ...
  const contextValue = useMemo(() => ({
    ...
    thumbSize,
    setThumbSize
  }), [values, minValue, maxValue, step, orientation, isDisabled, formatOptions, getThumbPercent, getThumbValueLabel, getThumbMinValue, getThumbMaxValue, updateValue, isThumbDragging, setThumbDragging, handleTapAtValue, trackSize, thumbSize]);
...
const Track = /*#__PURE__*/forwardRef(({
  asChild,
  children,
  onLayout,
  ...restProps
...
const Fill = /*#__PURE__*/forwardRef(({
  asChild,
  ...props
}, ref) => {
  const Component = asChild ? Slot.View : View;
...
const Output = /*#__PURE__*/forwardRef(({
  asChild,
  children,
  ...restProps
}, ref) => {
