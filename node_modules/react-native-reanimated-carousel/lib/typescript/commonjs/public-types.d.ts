...
import type { GestureStateChangeEvent, GestureType, GestureUpdateEvent, MouseButton, PanGestureChangeEventPayload, PanGestureHandlerEventPayload, PanGestureHandlerProps } from "react-native-gesture-handler";
...
type CarouselExternalGestureRef = GestureType | React.RefObject<GestureType | undefined> | React.RefObject<React.ComponentType | undefined>;
...
type CarouselPanChangeEvent = GestureUpdateEvent<PanGestureHandlerEventPayload & PanGestureChangeEventPayload>;
...
export type PaginationProps = PaginationBaseProps & (InteractivePaginationProps | DecorativePaginationProps);
